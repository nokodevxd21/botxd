const { ActionRowBuilder, ButtonBuilder, EmbedBuilder, ButtonStyle , WebhookClient} = require("discord.js");
...
const embed2 = new EmbedBuilder().setColor("#ff1010").setAuthor({name: `Player Destroyed`, iconURL: client.user.displayAvatarURL()}).setDescription(`Id: **${player.guild}**\nName: **${server.name}**`)
